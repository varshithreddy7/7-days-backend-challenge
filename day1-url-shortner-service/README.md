...
🌐 **Live Deployment**: https://seven-days-backend-challenge.onrender.com

---

## ✨ Features

- ✂️ **Short Code Generation**: Unique, collision-resistant 7-character short codes powered by \
anoid\ (/api/v1/url/shorten).
